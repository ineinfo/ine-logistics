...
export async function POST(req) {
    try {
        const { name, email, selectedOption, packagingSize, quantity, country, quality, additionalInfo } = await req.json();
        ...
        <div class="email-container">
          ...
          <div class="content">
            ...
            <div class="info-box">
              ...
              <p><strong>Packaging Size:</strong> ${packagingSize}</p>
          ...
          <div class="footer">
            <p>&copy; 2025 INE International. All rights reserved.</p>
