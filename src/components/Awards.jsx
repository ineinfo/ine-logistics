          ...
          <Row className="justify-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg mx-0.5 sm:mx-auto text-blue-900 text-center">
                We are certified by the Spice Board, ensuring the highest
                quality standards for spice exports. This certification
                strengthens our credibility in the global spice market.
              </p>
            </Col>
            <Col
              span={24}
            ...
            >
              ...
              <p className="text-base sm:text-lg mx-0.5 sm:mx-auto text-blue-900 text-center">
                Our APEDA certification authorizes us to export agricultural and
                processed food products. It ensures compliance with
                international trade regulations for seamless exports.
              </p>
            </Col>
            ...
            >
              ...
              <p className="text-base sm:text-lg mx-0.5 sm:mx-auto text-blue-900 text-center">
                As an MSME-registered business, we benefit from government
                support and incentives. This helps us enhance our export
                capabilities and expand globally.
              </p>
            </Col>
            ...
            <Col span={24} sm={5} className="justify-items-center sm:mx-auto">
              ...
              <p className="text-base sm:text-lg mx-0.5 sm:mx-auto text-blue-900 text-center">
                Our FSSAI certification guarantees that all our food products
                meet safety and quality standards. It enables us to provide
                trusted and compliant food exports worldwide.
              </p>
            </Col>
          </Row>
