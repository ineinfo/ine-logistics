  ...
  return (
    <>
      <div>
        ...
        <div className="text-center">
          <Row className="justify-center">
            <Col span={24} sm={5} className="flex flex-col items-center mb-10 sm:mb-0">
            ...
            {!screens.sm && (
              <Divider type="horizontal" className="border-blue-800 border-2 w-full" />
            )}
            ...
            <Col span={24} sm={5} className="flex flex-col items-center">
           <div  className="flex flex-col items-center">
           <img
                src="/imgs/fssai1.png"
                alt="FSSAI"
